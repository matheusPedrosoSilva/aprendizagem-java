...
public class TelaSaque extends JFrame {
    ...
    public TelaSaque() {
        ...
        JLabel lblTitulo = new JLabel("Saque");
        ...
        btnConfirmar.addActionListener((ActionEvent e) -> {
            try {
                ...
                if ("".equals(txtValor.getText())) {
                    ...
                    atualizacaoValida = usu.saque(Float.parseFloat(valorTexto), Usuario.usuarioSistema);

                    if (atualizacaoValida == true) {
                        JOptionPane.showMessageDialog(null, "Saque realizado", "Atencao", JOptionPane.INFORMATION_MESSAGE);
                        TelaInicio tInicio = new TelaInicio();
                        tInicio.abreTela();
                        dispose();
                    } else {
